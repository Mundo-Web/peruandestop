    ...
    <nav class="menu-list text-text20">
      <ul class="font-acehMedium">
        <ul class="flex flex-col gap-2 max-w-[280px] mx-auto">
          <li>
            <details class="group">
              <summary class="flex items-center justify-between gap-2  marker:content-none hover:cursor-pointer">
                <div class="flex gap-5 items-center">
                  <img src="./images/img/person.png" alt="" />

                  <span> Ademir Neyra</span>
                </div>
                <svg class="transition group-open:rotate-90" xmlns="http://www.w3.org/2000/svg" width="16"
    ...
    <div class="flex justify-center items-center md:justify-end gap-5 w-11/12 mx-auto py-4">
      ...
      <div class="text-white">
        <a href="#" class="flex gap-2 justify-center items-center">
          ...
          <img src="{{ asset('images/svg/carrito_icon.svg') }}" alt="carrito_tickets" class="w-6 h-6" />
        </a>
      </div>
    </div>
  </div>
        ...
        <div>
          <div class="dropdown-perfil inline-block relative">
            ...
            <ul
              ...
              <li>
                <a class="rounded-md hover:bg-gray-200 py-2 px-4 block whitespace-no-wrap" href="#">Home 1</a>
              </li>
              <li>
                <a class="rounded-md hover:bg-gray-200 py-2 px-4 block whitespace-no-wrap" href="#">Home 2</a>
              </li>
            </ul>
          </div>
        </div>
