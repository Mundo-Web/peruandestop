                                ...
                                <form action="">
                                    <div class="flex flex-col gap-5">
                                        <div class="flex flex-col gap-2 flex-auto">
                                            <label for="nombre" class="font-medium text-text14 text-[#344054]">Nombre de la Agencia de Viajes</label>
        
                                            <input id="nombre" type="text" placeholder="Agencia"
                                        ...
                                        <div class="flex flex-col md:flex-row gap-5 w-full">
                                            <div class="flex flex-col gap-2 flex-auto">
                                                ...
                                                <input id="nombre" type="text" placeholder="20 ...."
                                                    class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                            </div>
            
                                            <div class="flex flex-col gap-2 flex-auto">
                                                <label for="apellido" class="font-medium text-text14 text-[#344054]">No. de Registro de la Agencia</label>
                                                <input id="apellido" type="text" placeholder="00000-000"
                                                    class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                            </div>
                                        </div>
                                        <div class="flex flex-col gap-2 flex-auto">
                                            <label for="nombre" class="font-medium text-text14  text-[#344054]">Dirección legal</label>
        
                                            <input id="nombre" type="text" placeholder="Av, Calle, Jr, Psj..."
                                                class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                        </div>
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div>
                                                <div class="flex flex-col gap-2 flex-auto">
                                                    <label for="apellido" class="font-medium text-text14 md:text-text18 text-[#344054]">NE-mail</label>
                                                    <input id="apellido" type="email" placeholder="hola@mail.com"
                                                        class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-col gap-2 flex-auto">
                                            ...
                                            <input id="nombre" type="text" placeholder="www..."
                                                class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                        </div>

                                        <div class="flex flex-col gap-2 flex-auto">
                                            <label for="nombre" class="font-medium text-text14  text-[#344054]">Nombre del Representante Legal</label>
                                        ...
                                        <div class="flex flex-col md:flex-row gap-5 w-full">
                                            <div class="flex flex-col gap-2 flex-auto">
                                                <label for="nombre" class="font-medium text-text14  text-[#344054]">Identificación del Representante Legal</label>
            
                                                <input id="nombre" type="text" placeholder="DNI"
                                                    class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                            </div>
            
                                            <div class="flex flex-col gap-2 flex-auto">
                                                <label for="apellido" class="font-medium text-text14 text-[#344054]">Teléfono del Representante Legal</label>
                                                <input id="apellido" type="text" placeholder="+51 ...."
                                                    class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                            </div>
                                        </div>

                                        <div class="flex flex-col gap-2 flex-auto">
                                            <label for="nombre" class="font-medium text-text14  text-[#344054]">Email del Representante Legal</label>
        
                                            <input id="nombre" type="email" placeholder="DNI"
                                                class="w-full border-[1px] focus:outline-none border-gray-200 rounded-xl py-4 text-text16 md:text-text20 font-acehRegular" />
                                        </div>
                                        ...
                                        <div class="flex flex-col gap-3">
                                            ...
                                            <div>
                                                <a href="#" class="bg-[#244D82] text-white py-2 px-5 inline-flex justify-start items-center rounded-full gap-2">
                                            ...
                                            <div class="border border-dashed border-black roundex-2xl flex flex-col justify-center items-center py-10">
                                                <div class="flex justify-center items-center">
                                                    <img src="{{asset('images/img/header_1.png')}}" alt="">
                                                </div>
                                                <label for="upload" class="font-acehSemibold text-text16 text-[#3F76BB] text-center cursor-pointer">Haga click para cargar <span  class="text-[#495560]">o arrastre y suele</span> </label>
                                        ...
                                        <div class="w-full flex flex-col gap-2">
                                            <input type="submit" value="Confirmar Registro"
                                                ...
                                                <div class="flex justify-start items-center gap-2">
                                                    ...
                                                    <label for="acepta" class="text-[#495560] font-acehRegular text-text16">Usted acepta nuestra amigable política de privacidad</label>
                                            </div>
                                        </div>
                ...
                <div class="modal__mostrar-ordenar">
                    <div class="flex flex-col gap-5">
                        ...
                        <div
                            ...
                            <p class="text-[#3F76BB] font-acehSemibold text-text32 md:text-text40 leading-tight">Registro realizado con Éxitos</p>
                            <p class="text-[#495560] text-text18 font-acehRegular">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus sint beatae dolorum similiq.</p>

                            <div class="flex justify-center items-center">
                                <img src="{{asset('images/img/exitooo.png')}}" alt="" class="w-20 h-20 md:w-auto md:h-auto">
                            </div>

                            <div class="flex justify-center items-center">
                                <a href="#" class="bg-[#3F76BB] text-white font-acehbold text-text20 rounded-3xl py-2 px-5 cerrar_modal">Iniciar Sesión</a>
                            </div>
